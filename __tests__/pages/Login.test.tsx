...
describe('HomePage', () => {
  ...
  it('renders movie list when logged in', async () => {
    ...
    (useMovies as any).mockReturnValue({ movies: [{ id: 1, title: 'Test Movie', poster_path: null }], loading: false, error: null, setSearchQuery: vi.fn(), loadMore: vi.fn(), hasMore: false });
